                        ...
                        <div class="form-group form-inline">
                            ...
                            <select class="form-control" id="changePageSize" onchange="changePageSize()">
                                <c:forEach begin="1" end="5" var="count">
                                    <option <c:if test="${pageInfo.size==count}"> selected </c:if> >${count}</option>
                                </c:forEach>
                            </select> 条
                        </div>
                    </div>
                        ...
                        <ul class="pagination">
                            ...
                            <c:if test="${pageInfo.pages<10}">
                                <c:forEach begin="1" end="${pageInfo.pages}" var="pageNum">
                                    <li <c:if test="${pageInfo.pageNum==pageNum}">class="active"</c:if>><a
                                            href="${pageContext.request.contextPath}/orders/findAll.do?page=${pageNum}&size=${pageInfo.pageSize}">${pageNum}</a></li>
                                </c:forEach>
                            </c:if>
                            <%--如果总页数大于10--%>
                            <c:if test="${pageInfo.pages>10}">
